...
Source0  : https://files.pythonhosted.org/packages/63/53/edd4d25bef7d14bb7a197088e9352b3559b6a407defbe952342da79fbcfa/setuptools_scm-6.4.0.tar.gz
...
%prep
%setup -q -n setuptools_scm-6.4.0
cd %{_builddir}/setuptools_scm-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642455537
...
cp %{_builddir}/setuptools_scm-6.4.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
