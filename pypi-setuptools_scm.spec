...
Source0  : https://files.pythonhosted.org/packages/22/93/e08bbd33313247a9d816d9b6f58ca221cdcc3f9efa21cd5402e80a801133/setuptools_scm-6.4.1.tar.gz
...
%prep
%setup -q -n setuptools_scm-6.4.1
cd %{_builddir}/setuptools_scm-6.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642523141
...
cp %{_builddir}/setuptools_scm-6.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
