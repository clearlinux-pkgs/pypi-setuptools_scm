...
Source0  : https://files.pythonhosted.org/packages/4f/a4/00a9ac1b555294710d4a68d2ce8dfdf39d72aa4d769a7395d05218d88a42/setuptools_scm-8.1.0.tar.gz
...
%prep
%setup -q -n setuptools_scm-8.1.0
cd %{_builddir}/setuptools_scm-8.1.0
pushd ..
cp -a setuptools_scm-8.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715016018
