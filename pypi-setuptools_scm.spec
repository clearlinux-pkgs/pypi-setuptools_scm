...
Source0  : https://files.pythonhosted.org/packages/eb/b1/0248705f10f6de5eefe7ff93e399f7192257b23df4d431d2f5680bb2778f/setuptools-scm-8.0.4.tar.gz
...
%prep
%setup -q -n setuptools-scm-8.0.4
cd %{_builddir}/setuptools-scm-8.0.4
pushd ..
cp -a setuptools-scm-8.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702071901
...
cp %{_builddir}/setuptools-scm-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305 || :
