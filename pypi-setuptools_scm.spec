...
Version  : 7.0.3
Release  : 115
URL      : https://files.pythonhosted.org/packages/bc/e6/ac8b0c5076321b9b3e4318c32a8911a260d019be6584556a0b83a47dab4b/setuptools_scm-7.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/bc/e6/ac8b0c5076321b9b3e4318c32a8911a260d019be6584556a0b83a47dab4b/setuptools_scm-7.0.3.tar.gz
...
%prep
%setup -q -n setuptools_scm-7.0.3
cd %{_builddir}/setuptools_scm-7.0.3
pushd ..
cp -a setuptools_scm-7.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656513852
...
cp %{_builddir}/setuptools_scm-7.0.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-setuptools_scm/2807f3f1c4cb33b214defc4c7ab72f7e4e70a305
